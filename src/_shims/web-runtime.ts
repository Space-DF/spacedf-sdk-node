...
export function getRuntime({ manuallyImported }: { manuallyImported?: boolean } = {}): Shims {
    const recommendation = manuallyImported
        ...
        : `Add one of these imports before your first \`import … from 'spacedf-sdk'\`:
...
`;
    ...
    try {
        ...
        throw new Error(`this environment is missing the following Web Fetch API type: ${(error as any).message}. ${recommendation}`);
    }
