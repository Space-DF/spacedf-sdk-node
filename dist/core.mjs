...
import { uuid4 } from "./libs/utils.mjs";
import { VERSION } from "./version.mjs";
import { SpaceDFError, APIError, APIConnectionError, APIConnectionTimeoutError, APIUserAbortError } from "./error.mjs";
import { getDefaultAgent, fetch } from "./_shims/index.mjs";
...
export class APIClient {
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new SpaceDFError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
...
export const ensurePresent = (value) => {
    if (value == null)
        throw new SpaceDFError(`Expected a value to be given but received ${value} instead.`);
    return value;
};
/**
